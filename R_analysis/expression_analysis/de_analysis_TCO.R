...
png(file="heatmap_TCO_upreg1.png",height=2500,width=2500)
selected  <- rownames(top_table_e[1:200])
esetSel <- dp_eset[selected, ]
heatmap.2(exprs(esetSel), symm=FALSE,symkey=FALSE,symbreaks=TRUE, scale="row", density.info="none",
          key=TRUE)
dev.off()

#mat_fem vs pE
par(mar=c(4.1,4.1,4.1,4.1))
png(file="heatmap_TCO_upreg2.png",height=2500,width=2500)
...
#male vs mat_fem
par(mar=c(4.1,4.1,4.1,4.1))
png(file="heatmap_TCO_upreg3.png",height=2500,width=2500)
