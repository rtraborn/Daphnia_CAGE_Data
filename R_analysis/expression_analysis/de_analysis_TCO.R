...
png(file="heatmap_TCO_upreg1.png",height=2000,width=2200)
...
#mat_fem vs pE
par(mar=c(4.1,4.1,4.1,4.1))
png(file="heatmap_TCO_upreg2.png",height=2000,width=2200)
...
#male vs mat_fem
par(mar=c(4.1,4.1,4.1,4.1))
png(file="heatmap_TCO_upreg3.png",height=2000,width=2200)
