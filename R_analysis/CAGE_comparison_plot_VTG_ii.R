...
p1 <- plot + coord_cartesian(xlim = c(116142,127656)) + theme_bw()
...
p1_p <- plot_peaked + coord_cartesian(xlim = c(116142,127656)) + theme_bw() 
...
p3_p <- plot_peaked + coord_cartesian(xlim = c(116142,127656)) + theme_bw()
